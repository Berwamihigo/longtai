...
const WhyChooseUs = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-gray-700 to-white">
      <div className="container mx-auto px-4">
        <motion.h2
          ...
          className="text-4xl font-bold text-center mb-16 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-white"
        >
          Why Choose Us
        </motion.h2>
