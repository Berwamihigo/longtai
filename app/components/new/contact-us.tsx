...
export default function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Add success state handling here
    }, 1500);
  };
    ...
    <section className="px-6 py-16 md:py-24 bg-gradient-to-br from-gray-50 to-gray-300">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            Have questions or want to schedule a test drive? Our team is ready to assist you.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="p-8 md:p-10 bg-gray-50">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Experience the drive</h3>
              <p className="text-gray-600 mb-5">Schedule a test drive and feel the difference for yourself.</p>
        ...
        >
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-200">
            ...
            <h4 className="font-semibold text-lg text-gray-900 mb-1">Call Us</h4>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-200">
            ...
            <h4 className="font-semibold text-lg text-gray-900 mb-1">Email Us</h4>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-200">
            ...
            <h4 className="font-semibold text-lg text-gray-900 mb-1">Visit Us</h4>
